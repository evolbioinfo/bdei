...
Solution
*inferParameters(const string &treename, R *x0, const R *dub, R pie, R mu, R lambda, R psi, R p, R T, R u, R ut, int nbdirerr, int size_pool, int debug_, int nstarts);

R calculateLikelihood(const string &treename, R mu, R lambda, R psi, R p, R pie, R T, R u, R ut, int size_pool, int debug_);